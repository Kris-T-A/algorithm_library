...
// TODO: SpectrogramNonLinear has been changed so this test is not valid for this class anymore. Rewrite the test to test adaptive spectrogram instead when it has been
// implemented.
//
